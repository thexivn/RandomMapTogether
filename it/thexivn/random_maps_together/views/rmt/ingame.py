...
class RandomMapsTogetherIngameView(WidgetView):
    ...
    def __init__(self, game):
        ...
        self.subscribe("ui_toggle_player_settings", self.game.config.toggle_player_settings)
        self.subscribe("ui_toggle_pause", self.game.command_toggle_pause)
        self.subscribe("ui_toggle_scoreboard", self.game.views.scoreboard_view.command_toggle_scoreboard)
